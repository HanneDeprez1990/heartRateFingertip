...
De eerste view is de \emph{designer view}, weergegeven in Figuur \ref{fig:view_designer}.

\figuurmetlabel[\label{fig:view_designer}]{width=.8\linewidth}{module2/overviewAI2_tabs}{Designer view in MIT App Inventor 2. Overschakelen tussen views doe je rechtsbovenaan (blauwe rechthoek). Tabs zijn aangeduid in rood.}
