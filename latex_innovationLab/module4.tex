...
Wat we in dit project doen, is zeer gelijkaardig: we kijken voor welke waarde van $i$ $u_{i}-u_{i-1}$ overgaat van een positieve naar een negatieve waarde om een piek, dit is een maximum, te detecteren. 
